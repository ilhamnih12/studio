...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ...
    className={cn(
      ...
      // Removed default mt-2 and orientation-specific margins for better control within layouts
      className
    )}
    {...props}
  />
