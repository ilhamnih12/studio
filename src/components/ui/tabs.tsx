...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ...
    className={cn(
      ...
      // Remove default margin-top for seamless content switching in mobile view
      "data-[orientation=vertical]:mt-0 data-[orientation=horizontal]:mt-0",
      className
    )}
    {...props}
  />
